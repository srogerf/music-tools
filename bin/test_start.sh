...
usage() {
  cat >&2 <<'EOF'
Usage: bash bin/test_start.sh

Starts the built test artifact server using .private/env/test/ by default.
This serves the production-style frontend bundle and built Go binary.
EOF
}
