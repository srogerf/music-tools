...
When enabled, the panel lets the user generate a random scale challenge from a
selected scale set:

- Major / minor
- Modes
- Pentatonic
- All supported learning scales

Each challenge includes a random key, scale, and CAGED position. The fretboard
stays blank until the user checks the answer.
