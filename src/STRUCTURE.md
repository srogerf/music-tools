...
## Purpose
`src/` holds reusable internal code that does not belong to tools, servers, or frontend apps.

## Guidelines
- Each subdirectory under `src/` must include a `README.md` describing its purpose and ownership.
- Keep code focused on reusable logic; avoid entry points or executables here.
